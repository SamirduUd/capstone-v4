...
*/
    stage('Create AWS network') {
      steps {
        ...
        AWS("cloudformation create-stack --stack-name CreateNetwork --template-body file://network.yml --parameters file://network-params.json --capabilities CAPABILITY_NAMED_IAM")
        }
      }
    }
